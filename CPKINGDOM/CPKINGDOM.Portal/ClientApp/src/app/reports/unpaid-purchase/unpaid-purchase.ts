...
@Component({
    selector: 'unpaid-purchase',
    /*styleUrls: ['./reorder-point.css'],*/
    templateUrl: './unpaid-purchase.html'
})
export class UnpaidPurchaseComponent implements OnInit {
    modalRef: NgbModalRef;
    transactions: TransactionHead[];
    constructor(private modalService: NgbModal, private reportService: ReportService) {
    }
    ngOnInit(): void {
        this.reportService.getUnpaidPurchase().subscribe(res => {
